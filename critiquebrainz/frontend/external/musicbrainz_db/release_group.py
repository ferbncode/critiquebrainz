...
def fetch_multiple_release_groups(*, mbids, includes=None):
    ...
    with mb_session() as db:
        ...
        if 'release-group-rels' in includes:
            entity_relation_helper(db, 'release_group', 'release_group', release_group_ids, includes_data)

        if 'url-rels' in includes:
            entity_relation_helper(db, 'url', 'release_group', release_group_ids, includes_data)
