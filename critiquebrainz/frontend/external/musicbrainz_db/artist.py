...
def fetch_multiple_artists(mbids, *, includes=None):
    ...
    with mb_session() as db:
        ...
        artists = get_entities_by_gids(query, models.Artist, models.ArtistGIDRedirect, mbids)
    ...
    artists = {str(artist.gid): to_dict_artists(artist, includes_data[artist.id]) for artist in artists}
    return artists
