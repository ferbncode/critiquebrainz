...
def entity_relation_helper(db, target_type, source_type, source_entity_ids, includes_data):
    ...
    if relation.entity0.property.mapper.class_ == relation.entity1.property.mapper.class_:
        get_relationship_links(relation, query, "entity0", "entity1", target_type, source_entity_ids, includes_data)
        get_relationship_links(relation, query, "entity1", "entity0", target_type, source_entity_ids, includes_data)
    else:
...
def get_relationship_links(relation, query, source_attr, target_attr, target_type, source_entity_ids, includes_data):
